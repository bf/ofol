...
local FilenameComponentFactory = {}

-- returns string for filename display in window title
function FilenameComponentFactory.get_filename_for_window_title(absolute_path) 
...
-- returns FilenameComponent object for rendering in tree view
function FilenameComponentFactory.get_filename_for_tree_view(absolute_path,  is_active, is_hovered)
  ...
  local object_for_rendering = FilenameComponent(filename_text, filename_color, filename_is_bold, icon_symbol, icon_color, suffix_text, suffix_color)
...
-- returns FilenameComponent object for rendering in tab title
function FilenameComponentFactory.get_filename_for_tab_title(absolute_path,  is_active, is_hovered)
  -- stderr.debug("absolute_path %s is_active:%s is_hovered:%s", absolute_path, is_active, is_hovered)
...
return FilenameComponentFactory